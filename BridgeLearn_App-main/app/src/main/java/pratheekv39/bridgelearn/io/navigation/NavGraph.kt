...
import pratheekv39.bridgelearn.io.ui.screens.TopicDetailScreen
...
// --- IMPORTS DARI FOLDER SIMULATIONS (YANG BENAR) ---
import pratheekv39.bridgelearn.io.ui.simulations.AcidBaseInteractiveLab
import pratheekv39.bridgelearn.io.ui.simulations.PendulumScreen       // <--- Benar (dari simulations)
import pratheekv39.bridgelearn.io.ui.simulations.SpringScreen
import pratheekv39.bridgelearn.io.ui.simulations.NewtonsLawsScreen    // <--- Benar (dari simulations)
...
fun NavGraph(
    ...
    // ✅ Hanya 4 tab: Home, Quiz, Learn, Profile
    val screens = listOf(Screen.Home, Screen.Quiz, Screen.Learn, Screen.Profile)

    // --- START DESTINATION KE "REGISTER" JIKA BELUM LOGIN ---
    ...
    Scaffold(
        ...
        NavHost(
            ...
            // Panggil PendulumScreen dari folder simulations
            ...
            // Panggil NewtonsLawsScreen dari folder simulations
